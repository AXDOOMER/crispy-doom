  ...
  int		height )
{
    ...
    dest = (pixel_t*) Z_Malloc(width*height*sizeof(*dest), PU_STATIC, 0);
...
( int	x,
  ...
  int	height )
{
    wipe_scr_start = Z_Malloc(SCREENWIDTH * SCREENHEIGHT * sizeof(pixel_t), PU_STATIC, NULL);
...
( int	x,
  ...
  int	height )
{
    wipe_scr_end = Z_Malloc(SCREENWIDTH * SCREENHEIGHT * sizeof(pixel_t), PU_STATIC, NULL);
